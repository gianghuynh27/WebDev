...
function AiCoachPage() {
  ...
  setCoachResponse({
    ...
    confidence: "medium",
    reasoning:
      "Your augments point toward a flexible backline carry comp with stable frontline options.",
    gamePlan: [
      "Play strongest board through stage 3.",
      "Prioritize carry items for your main damage dealer.",
      "Look for frontline upgrades before committing fully.",
    ],
  ...
  return (
   <div className="space-y-8">
    ...
    <form onSubmit={handleSubmit} className="space-y-4 rounded-xl border border-slate-800 bg-slate-950 p-4">
      <div>
